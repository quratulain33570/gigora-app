...
function Pricing() { return <section className="rounded-3xl bg-white p-6 shadow-sm"><h1 className="text-2xl font-black">Simple pricing</h1><div className="mt-6 overflow-x-auto"><table className="w-full min-w-[480px] text-left"><thead><tr className="border-b"><th className="p-3">Feature</th><th className="p-3">Free</th><th className="p-3">Pro</th></tr></thead><tbody><tr className="border-b"><td className="p-3">AI generations</td><td className="p-3">5 free uses</td><td className="p-3">Unlimited</td></tr><tr><td className="p-3">History</td><td className="p-3">Basic</td><td className="p-3">Full history</td></tr></tbody></table></div></section>; }
